...
# accelerate test
nohup accelerate launch --multi_gpu --mixed_precision fp16 train_greyscale_MoE.py --config=configs/acdc_wholeheart_uncond_uvit_MoE_greyscale_mid_4by4.py --workdir output/acdc_wholeheart_uncond_moe_greyscale_uvit_mid_4by4