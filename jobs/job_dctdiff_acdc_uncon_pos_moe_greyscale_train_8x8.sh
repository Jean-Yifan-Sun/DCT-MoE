...
# accelerate test
nohup python train_greyscale_Pos_MoE.py --config=configs/acdc_wholeheart_uncond_uvit_Pos_MoE_greyscale_mid_8by8.py --workdir output/acdc_wholeheart_uncond_pos_moe_greyscale_uvit_mid_8by8
