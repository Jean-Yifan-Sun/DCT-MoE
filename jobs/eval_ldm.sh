...
accelerate launch \
    ...
    --main_process_port=0 \
    eval_ldm.py \
    --config=configs_ldm/acdc_wholeheart_uncond_uvit_mid_p2.py \
    --workdir=output_ldm/acdc_wholeheart_uncond_uvit_mid_p2
...
accelerate launch \
    ...
    --main_process_port=0 \
    eval_ldm.py \
    --config=configs_ldm/echonet_uncond_uvit_mid_p2.py \
    --workdir=output_ldm/echonet_uncond_uvit_mid_p2