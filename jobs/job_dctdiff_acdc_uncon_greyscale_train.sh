...
# accelerate test
nohup accelerate launch --multi_gpu --mixed_precision fp16 train_greyscale.py --config=configs/acdc_uncond_uvit_greyscale_mid_4by4.py --workdir output/acdc_uncond_greyscale_uvit_mid_4by4