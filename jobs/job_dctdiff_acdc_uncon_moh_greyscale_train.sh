...
# accelerate test
nohup python train_greyscale_MoE.py --config=configs/acdc_wholeheart_uncond_uvit_MoH_greyscale_mid_4by4.py --workdir output/acdc_wholeheart_uncond_moh_greyscale_uvit_mid_4by4